...
{ href: '/coaching', tag: 'Leadership & Professional Coaching', title: 'Grow. Navigate Change. Prepare for What\u2019s Next.', desc: 'One-to-one coaching for emerging leaders, new managers and supervisors, mid-career professionals, and professionals navigating career transitions. Whether you\u2019re stepping into greater responsibility, working through a challenge, navigating change, making an important decision, or considering what\u2019s next, coaching gives you dedicated space to think, grow, and move forward with greater clarity and intention.', delay: '0.12s' },
{ href: '/coaching/parents', tag: 'Coaching for Parents', title: 'You Carry a Lot. Make Space for You.', desc: 'Parenting is only one part of your life. One-to-one coaching gives you space to think through work, relationships, personal growth, family, important decisions, and what is next. Strengthen how you show up everywhere.', delay: '0.24s' },
{ href: '/impact', tag: 'The Impact Lab', title: 'Step up. Solve problems. Create impact.', desc: 'Cohort programs built to move people from where they are to who they are capable of becoming. Three programs, one path. Find your direction, build your impact, raise it in others.', delay: '0.36s' },
      ...
      <style>{`
        @media (max-width: 860px) {
          ...
          .hero-split > div:last-child { min-height: 480px !important; aspect-ratio: 3/4; width: 100% !important; }
        }
