  ...
  return (
    <div style={{ minHeight: '100vh', fontFamily: 'var(--font-montserrat), sans-serif', background: 'var(--paper)' }}>
      ...
      <div style={{ display: 'flex', paddingTop: '64px', minHeight: '100vh' }}>
        ...
        <div className="portal-sidebar" style={{ width: '240px', background: 'var(--navy)', borderRight: '1px solid rgba(200,136,32,0.15)', display: 'flex', flexDirection: 'column', flexShrink: 0, minHeight: 'calc(100vh - 64px)', position: 'sticky', top: '64px', height: 'calc(100vh - 64px)', overflowY: 'auto' }}>
        ...
        <div style={{ flex: 1, padding: 'clamp(1.25rem, 3vw, 2rem)', minWidth: 0 }}>
          ...
          {page === 'action-plan' && (
            <div>
              <span style={{ fontFamily: 'var(--font-jetbrains), monospace', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--gold)' }}>Action Plan</span>
              <h1 style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--navy)', letterSpacing: '0.04em', marginTop: '0.25rem', marginBottom: '1.5rem' }}>Goals &amp; Action Items</h1>
              <div style={cardStyle}>
                <h3 style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: '1.1rem', color: 'var(--navy)', letterSpacing: '0.04em', marginBottom: '1rem' }}>Current Coaching Goals</h3>
                {['Develop a stronger executive presence in high-stakes meetings', 'Build trust and psychological safety with my direct reports', 'Communicate with clarity and confidence under pressure'].map((goal, i) => (
                  <div key={i} style={{ display: 'flex', gap: '0.75rem', padding: '0.75rem 0', borderBottom: '1px solid var(--mist)', alignItems: 'flex-start' }}>
                    <span style={{ color: 'var(--gold)', fontWeight: 700, flexShrink: 0 }}>0{i + 1}</span>
                    <span style={{ color: 'var(--ink)', fontSize: '0.9rem', lineHeight: 1.55 }}>{goal}</span>
                  </div>
                ))}
              </div>
              <div style={cardStyle}>
                <h3 style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: '1.1rem', color: 'var(--navy)', letterSpacing: '0.04em', marginBottom: '1rem' }}>Active Action Items</h3>
                {[
                  ...
                  { item: 'Read chapters 3 and 4 of the recommended book', due: 'July 8', done: false },
                  ...
                  <div key={i} style={{ display: 'flex', gap: '0.75rem', padding: '0.75rem 0', borderBottom: '1px solid var(--mist)', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <span style={{ display: 'block', fontFamily: 'var(--font-jetbrains), monospace', fontSize: '0.6rem', color: 'var(--gold)', letterSpacing: '0.1em', marginTop: '0.2rem' }}>Due {due}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              {journalEntries.map((entry, i) => (
                <div key={i} style={{ ...cardStyle, borderLeft: '3px solid var(--gold)' }}>
                  <span style={{ fontFamily: 'var(--font-jetbrains), monospace', fontSize: '0.6rem', letterSpacing: '0.1em', color: 'var(--gold)', textTransform: 'uppercase', display: 'block', marginBottom: '0.5rem' }}>{entry.date}</span>
          ...
          {page === 'resources' && (
            <div>
              ...
              <h1 style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--navy)', letterSpacing: '0.04em', marginTop: '0.25rem', marginBottom: '1.5rem' }}>Your Resource Library</h1>
              {[
          ...
          {page === 'assessments' && (
            <div>
              ...
              <h1 style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', color: 'var(--navy)', letterSpacing: '0.04em', marginTop: '0.25rem', marginBottom: '1.5rem' }}>Assessments &amp; Exercises</h1>
              {[
                ...
                <form onSubmit={e => { e.preventDefault(); setCheckInSubmitted(true) }} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  {[
                    ...
                    <div key={key} style={cardStyle}>
                      <label style={{ fontFamily: 'var(--font-jetbrains), monospace', fontSize: '0.6rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'var(--gold)', display: 'block', marginBottom: '0.6rem' }}>{label}</label>
